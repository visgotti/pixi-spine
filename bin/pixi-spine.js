...
(function (pixi_spine) {
    var DynamicCombinedSkin = (function (_super) {
        ...
        DynamicCombinedSkin.prototype.addToSkeletonWithSkins = function (skinNames) {
            this.changeSkins(skinNames);
            this.skeleton.skin = this;
        };
        DynamicCombinedSkin.prototype.addToSkeleton = function () {
            this.skeleton.skin = this;
        };
        DynamicCombinedSkin.prototype.setSlotsToDefault = function (slotNames) {
        ...
        DynamicCombinedSkin.prototype.changeSkins = function (skinNames) {
            for (var i = 0; i < skinNames.length; i++) {
                this.changeSkin(skinNames[i]);
            }
        };
        return DynamicCombinedSkin;
    }(pixi_spine.core.Skin));
    pixi_spine.DynamicCombinedSkin = DynamicCombinedSkin;
})(pixi_spine || (pixi_spine = {}));
(function () {
    if (!Math.fround) {
